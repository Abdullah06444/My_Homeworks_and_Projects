	...
	function(e, t, n)
	{
		...
		//DEĞİŞTİRDİM AMA Bİ DEĞİŞİKLİK YOK KALDIRILABİLİR TEKRAR ÖNEMLİYSE!!!!
			...
			imageFinal: function()
			{
				...
				if (i.download == true)
				{
					var o = t('<div class="download final"style="opacity:0.40;filter:alpha(opacity=40)" onmouseover="this.style.opacity=1;this.filters.alpha.opacity=100" onmouseout="this.style.opacity=0.40;this.filters.alpha.opacity=40" />');
