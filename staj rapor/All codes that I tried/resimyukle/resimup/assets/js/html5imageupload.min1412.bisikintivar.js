	...
	function(e, t, n)
	{
		...
		t.html5imageupload.prototype = 
		{
			_init: function()
			{
				...
				{
					// !!!!!!!! BURAYI KAPATTIM AMA SANKİ ALTTAKİ FOTOĞRAF GİTTİ GİBİ KAPATINCA AMA
					//t(i).data("name", r.image).append(t("<img />").addClass("preview").attr("src", r.image));

					var l = t('<div class="preview tools" style="opacity:0;filter:alpha(opacity=0)" onmouseover="this.style.opacity=1;this.filters.alpha.opacity=100" onmouseout="this.style.opacity=0;this.filters.alpha.opacity=0"></div>');
					...
					//osman = t(l); //BURDA BİŞEYLER OLDU DA.. ARTIK :(
					//osmanh=h;
			...
			readImage: function(e, n, r, i) //crop yapanın içine foto atıyo
			{
				...
				a.onload = function(e)
				{
					...
					t(u).append(t('<div class="cropWrapper" style="opacity:0;filter:alpha(opacity=0)" onmouseover="this.style.opacity=1;this.filters.alpha.opacity=100" onmouseout="this.style.opacity=0;this.filters.alpha.opacity=0"></div>').append(t(s.image)));
		...
		//DEĞİŞTİRDİM AMA Bİ DEĞİŞİKLİK YOK KALDIRILABİLİR TEKRAR ÖNEMLİYSE!!!!
			...
			imageFinal: function()
			{
				...
				var s = t('<div class="tools final" style="opacity:0;filter:alpha(opacity=0)" onmouseover="this.style.opacity=1;this.filters.alpha.opacity=100" onmouseout="this.style.opacity=0;this.filters.alpha.opacity=0">');
				...
				if (i.download == true)
				{
					var o = t('<div class="download final" style="opacity:0;filter:alpha(opacity=0)" onmouseover="this.style.opacity=1;this.filters.alpha.opacity=100" onmouseout="this.style.opacity=0;this.filters.alpha.opacity=0" />');
			...
			_tools: function()
			{
				var n = this;
				var r = n.element;
				var i = t('<div class="tools" style="opacity:0;filter:alpha(opacity=0)" onmouseover="this.style.opacity=1;this.filters.alpha.opacity=100" onmouseout="this.style.opacity=0;this.filters.alpha.opacity=0"></div>');
